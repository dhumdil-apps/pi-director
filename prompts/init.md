...
Use the normal explore, ask, plan, approval, execute, and close-out workflow. This command may create or revise shared `AGENTS.md`, Pi-local `.pi/AGENTS.md`, and project memory, so show the proposed changes before writing them.
