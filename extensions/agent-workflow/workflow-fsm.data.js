...
window.WORKFLOW_FSM_DATA = {
  ...
  "summary": "7-E Compound Lifecycle across user-owned modes: ALIGN (envision entry, evaluate primary, establish secondary), SPEC (explore primary, elaborate secondary), VIBE (execute primary, examine secondary). New interactive sessions and handoffs start at envision in ALIGN. Each mode has a primary home for active work (tools stay in-step) and a secondary gate to capture/verify and CALL next. In-mode loop is bidirectional body (TO_GATE primary→secondary, TO_HOME secondary→primary). Runtime owns native UI, session identity, timing, persistence mechanics, and mode markers. Agent owns judgment, artifact meaning, scope, decisions, and final output.",
  "session": {
  ...
  "transitions": [
    ...
    },
    {
      ...
      "to": "establish",
      "label": "ALIGN",
      "description": "Align body ⇄: TO_GATE evaluate→establish (confirm/summarize); TO_HOME establish→evaluate when more primary/ask work; next only from establish.",
      "bidirectional": true
    },
    {
    ...
    },
    {
      ...
      "to": "elaborate",
      "label": "SPEC",
      "description": "Spec body ⇄: TO_GATE explore→elaborate (confirm/summarize); TO_HOME elaborate→explore when more research; next only from elaborate.",
      "bidirectional": true
    },
    {
    ...
    },
    {
      ...
      "to": "examine",
      "label": "VIBE",
      "description": "Vibe body ⇄: TO_GATE execute→examine (confirm/summarize); TO_HOME examine→execute when more implementation; next only from examine.",
      "bidirectional": true
    },
    {
