...
models. Status Bar then hides the hourly slot when weekly has data (one dim `n/a`
only if both are missing), and may fill weekly from its unmatched override settings.
