...
These two are the bundle's only workflow tools. Close-out has none: the outcome is reported in the turn, and orientation, work-arounds or other quirks, and a summary of where the project stands go to `.pi/MEMORY.md`, which the agent writes directly.
