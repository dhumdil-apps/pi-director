...
- **pi-inspector skill & bridge** — Runs Inspector regression suites/flows, diagnoses their shared step evidence, and reports Director phase/session context over the display-only channel.
